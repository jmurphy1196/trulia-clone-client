      ...
      <div className="edit-profile">
        ...
        <div className="content-body">
          <div className="body-left">
            ...
            <span>
              Your profile is private. If you have a Rental Resume, use its
              share setting to send it with rental inquiries. No one else will
              see it.
            </span>
          </div>
            ...
            <form onSubmit={this.submitEditProfile}>
              ...
              <div>
                <label for="name">
                  Your full name{" "}
                  {errors !== null ? (
                    <span className="error-helper">{errors.fullName}</span>
                  ) : null}
                </label>
                {user.credentials.fullName ? (
                  <input
                    ...
                    id="name"
                    type="text"
                    placeholder={user.credentials.fullName}
                  />
                ) : (
                  <input
                    name="fullName"
              ...
              <div>
                <label for="phone">
                  Phone{" "}
                  {errors !== null ? (
                    <span className="error-helper">{errors.phone}</span>
                  ) : null}
                </label>
                {user.credentials.phone ? (
                  <input
                    ...
                    id="name"
                    type="text"
                    placeholder={user.credentials.phone}
                  />
                ) : (
                  <input
                    name="fullName"
              ...
              <div>
                <label for="location">
                  Location{" "}
                  {errors !== null ? (
                    <span className="error-helper">{errors.location}</span>
                  ) : null}
                </label>
                {user.credentials.fullName ? (
                  <input
                    ...
                    id="name"
                    type="text"
                    placeholder={user.credentials.location}
                  />
                ) : (
                  <input
                    name="fullName"
              ...
              <div id="profile-submit">
                <button onClick={this.submitEditProfile} type="submit">
                  {loading ? (
