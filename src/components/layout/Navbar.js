...
import { loginUser, getUserDetails, logoutUser } from '../../redux/actions/userActions';
            ...
            <React.Fragment>
                ...
                <ul className='right-menu'>
                    ...
                    <li> 
                        ...
                        {authenticated === false ? (
                            <li className='login-btn' onClick={this.logUser}>
                                <h4>Sign up or Log in</h4>
                                </li>
                        ) : (          
                                    <li className='logged-btn'>
                                    <h4><i className="fas fa-user"></i>  {this.state.displayName}</h4>
                                    </li>
                        )}
                        
                        <li id='mobile'>
                            <div className='hamburger-icon' onClick={() => this.openMobile(false)}>
                ...
                {this.state.mobileMenu === true ? (
                    <MobileNavbarWrapper>
                        <MobileNavbar  openMobile={() => this.openMobile(true)} displayName={this.state.displayName} />
